...
internal enum Asset {
  internal static let iconAccessibilityOff = ImageAsset(name: "icon_accessibilityOff")
  ...
  internal static let iconZoomAndRotate = ImageAsset(name: "icon_zoomAndRotate")
}
